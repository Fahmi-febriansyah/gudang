...
if (isset($_POST['submit'])) {
  ...
  $cuan = mysqli_query($koneksi,"INSERT INTO barang VALUES('','$nama_barang','$ukuran_barang','$type','$stok')");
  if ($cuan) {
    echo "<script>
    alert('Berhasil masukan barang');
    document.location.href = 'barang.php'
    </script>";
  }else{
    echo "<script>
    alert('gagal masukan barang');
    document.location.href = 'add-barang.php'
    </script>";
  }
}
?>
    ...
    <div class="container mt-5">
      ...
      <form method="POST" class="p-3 shadow m-2">
        ...
        <div class="form-group my-3">
          ...
          <input type="text" name="nama-barang" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Masukkan Nama Barang">
        </div>
        <div class="form-group my-3">
          <label for="basic-url">Ukuran Barang</label>
          <input type="text" name="ukuran" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Masukkan Ukuran Barang">
        </div>
        <div class="form-group my-3">
        ...
        <div class="form-group my-3">
          ...
          <input type="text" name="stok" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Masukkan Stok Barang">
        </div>
